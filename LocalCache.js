...
(function() {
  ...
  LocalCache = (function() {
    ...
    function LocalCache(directoryForNodeJSCache, quotaForNodeJSCache, keyForMetaData, localStorageObject) {
      var LocalStorage;
      this.directoryForNodeJSCache = directoryForNodeJSCache != null ? directoryForNodeJSCache : './local-storage-cache';
      this.quotaForNodeJSCache = quotaForNodeJSCache != null ? quotaForNodeJSCache : 5 * 1024 * 1024;
      ...
      */
      ...
      if (localStorageObject != null) {
        if ((localStorageObject.setItem != null) && (localStorageObject.getItem != null) && (localStorageObject.removeItem != null)) {
        ...
        try {
          ...
          LocalCache.localStorage = new LocalStorage(this.directoryForNodeJSCache, this.quotaForNodeJSCache);
        } catch (err) {
          LocalCache.localStorage = null;
        }
      }
    ...
    LocalCache.prototype.setItem = function(key, value) {
      ...
      */
      ...
      if (LocalCache.localStorage != null) {
        while (true) {
          try {
